...
![image-20241027203118411](Java基础.assets/image-20241027203118411.png)
...
![img](Java基础.assets/shangtou-04.png)
...
![img](Java基础.assets/2135194-20201115031408498-651802370.png)
...
![img](Java基础.assets/2135194-20201115032051472-76660950.png)

因此就有了我提供的代码里面的那种写法，缓冲区数组不再一个个读取，而是一次读取一个字符数组，这样在缓冲区读写这个部分进行了再次优化，实际过程如下（部分）

![img](Java基础.assets/2135194-20201115033226792-699674964.png)
...
![img](Java基础.assets/buffer-20230321154534.png)
...
![img](Java基础.assets/buffer-20230321162808.png)
