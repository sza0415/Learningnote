HTML（超文本标记语言）页面结构 CSS（Cascading Style Sheet 层叠样式表）内容样式 JS交互
...
- JS对象
  ...
  - DOM
    ...
    ![image-20241104143052309](./%E5%89%8D%E7%AB%AF%E5%85%A5%E9%97%A8.assets/image-20241104143052309.png)
